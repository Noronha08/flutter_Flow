            ...
            children: [
                ...
                child: TextFormField(
                  ...
                  onChanged: (_) => EasyDebounce.debounce(
                    ...
                    () async {
                      ...
                      _model.apiResult = await BuscarCEPCall.call(
                      ...
                      if ((_model.apiResult?.succeeded ?? true)) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'ops algo esta errado com seu CEP',
                              style: TextStyle(
                                color: FlutterFlowTheme.of(context).primaryText,
                              ),
                            ),
                  ...
                  validator:
                      _model.tFCepTextControllerValidator.asValidator(context),
                ),
              ),
              Container(
                width: 200.0,
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enableInteractiveSelection: true,
                  validator:
                      _model.tFRuaTextControllerValidator.asValidator(context),
                ),
              ),
            ],
          ),
